  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Pickup photo proof */}
        {order.pickup_photo ? (
          <Animated.View entering={FadeInUp.delay(260)} style={styles.proofCard} testID="summary-pickup-proof-card">
            <Image source={{ uri: order.pickup_photo }} style={styles.proofThumb} />
            <View style={{ flex: 1 }}>
              <Text style={styles.proofTitle}>Pickup proof captured</Text>
              <Text style={styles.proofSub}>Items received from merchant</Text>
            </View>
            <Ionicons name="bag-check" size={22} color={theme.primary} />
          </Animated.View>
        ) : null}
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: theme.textSecondary, textAlign: "center", marginTop: 6, paddingHorizontal: spacing.md },
  earnCard: {
  ...
  earnAmount: { fontSize: 52, fontWeight: "900", color: "#fff", letterSpacing: -2, marginVertical: 4 },
  ...
  breakdownValue: { color: "#fff", fontWeight: "700", fontSize: 15, marginTop: 4 },
  vDivider: { width: 1, height: 28, backgroundColor: "rgba(255,255,255,0.18)" },
  ratingCard: { marginTop: spacing.lg, padding: spacing.lg, backgroundColor: theme.surface, borderRadius: radius.xl, borderWidth: 1, borderColor: theme.border },
  proofCard: {
  ...
  actionsContainer: { gap: 10, marginTop: spacing.xl },
